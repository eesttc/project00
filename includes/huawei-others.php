...
<head>
  ...
  <title>Other Huawei products</title>
  <!-- Bootstrap CSS -->
...
<body>
  ...
  <?php 
    try {
      $sql = "SELECT id, name, price, image_url, features FROM products WHERE name LIKE '%uawei%' AND name NOT LIKE '%hone%' ORDER BY name";
  ...
  <div class="container-apple">
    <h2 class="text-center my-4">Other Huawei products</h2>
