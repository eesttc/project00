...
<head>
  ...
  <title>Other products from Samsung</title>
  <!-- Bootstrap CSS -->
...
<body>
  ...
  <?php 
    try {
      $sql = "SELECT id, name, price, image_url, features FROM products WHERE brand_id = 1 AND type LIKE 'others' ORDER BY id";
  ...
  <div class="container-apple">
    <h2 class="text-center my-4">Other products from Samsung</h2>
