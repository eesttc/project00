...
<body>
  ...
  <?php 
    try {
      $sql = "SELECT id, name, price, image_url, features FROM products WHERE name LIKE '%uawei%' AND '%hone%' ORDER BY name";
  ...
  <div class="container-apple">
    <h2 class="text-center my-4">Huawei phone list</h2>
