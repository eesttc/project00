...
<body>
  ...
  <?php 
    try {
      $sql = "SELECT id, name, price, image_url, features FROM products WHERE brand_id = 6 AND type LIKE 'others' ORDER BY id";
  ...
  <div class="container-apple">
    <h2 class="text-center my-4">Other products from Xiaomi</h2>
