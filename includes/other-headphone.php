...
<body>
  ...
  <?php 
    try {
      $sql = "SELECT id, name, price, image_url, features FROM products WHERE brand_id = 5 AND type LIKE 'headphone' ORDER BY id";
  ...
  <div class="container-apple">
    <h2 class="text-center my-4">Headphone list</h2>
