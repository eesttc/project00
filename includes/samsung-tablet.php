...
<body>
  ...
  <?php 
    try {
      $sql = "SELECT id, name, price, image_url, features FROM products WHERE brand_id = 1 AND type LIKE 'tablet' ORDER BY id";
  ...
  <div class="container-apple">
    <h2 class="text-center my-4">Samsung tablets list</h2>
