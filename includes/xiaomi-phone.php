...
<body>
  ...
  <?php 
    try {
      $sql = "SELECT id, name, price, image_url, features FROM products WHERE brand_id = 6 AND type LIKE 'phone' ORDER BY id";
  ...
  <div class="container-apple">
    <h2 class="text-center my-4">Xiaomi phone list</h2>
