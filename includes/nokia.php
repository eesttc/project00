...
<body>
  ...
  <?php 
    try {
      $sql = "SELECT id, name, price, image_url, features FROM products WHERE brand_id = 3 ORDER BY id";
  ...
  <div class="container-apple">
    <h2 class="text-center my-4">Nokia products list</h2>
